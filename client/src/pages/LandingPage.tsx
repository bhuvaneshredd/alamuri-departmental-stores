        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight mb-4">
            ...
            <span className="bg-gradient-to-r from-emerald-400 via-teal-300 to-amber-300 bg-clip-text text-transparent">
              Alamuri Departmental Stores
            </span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-2xl leading-relaxed mb-8">
            Your trusted neighborhood daily grocery store. Farm fresh vegetables, fruits, daily dairy, breakfast essentials, pantry staples & snacks delivered fresh in minutes.
          </p>
        ...
        <div className="space-y-3 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-2">
            ...
            <h3 className="text-lg sm:text-xl font-black">
              Alamuri Departmental Stores — Physical Counter
            </h3>
          </div>
