        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-10">
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-gray-500 max-w-sm leading-relaxed mb-4">
              Metro Retail Supermarket — Your trusted neighborhood superstore for fresh groceries, staples, dairy, beverages, snacks, and household essentials.
            </p>
            <div className="flex flex-col gap-1.5 text-xs text-gray-500">
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-emerald-600 shrink-0" />
                <span>{settings?.storeAddress || '14/A Commercial Market Road, Indiranagar, Bengaluru, 560038'}</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{settings?.storeEmail || 'support@metrosupermarket.com'}</span>
              </div>
            </div>
          </div>
